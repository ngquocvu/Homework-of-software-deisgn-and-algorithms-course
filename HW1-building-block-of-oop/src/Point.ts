export class Point {
  ...
  //TypeScript allows you to declare overloads but you can only have one implementation and that implementation must have a signature that is compatible with all overloads.
  constructor();
